    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Yeni kullanıcı şifre ile hesap oluşturdu.");

                    // ======================================================
                    // 🔥 MEMBER TABLOSUNA OTOMATİK EKLEME
                    // ======================================================
        ...
        private IdentityUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"IdentityUser oluşturulamadı. Register.cshtml.cs dosyasını kontrol edin.");
            }
        }
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Bu sistem EmailStore gerektiriyor.");
            }
